...
export default class Calendar extends React.Component {
  ...
  renderCurrentMonth = (date = this.state.date) => {
    ...
    return (
      <div
        className={classes.join(" ")}
        onClick={this.props.monthHeaderClickHandler}
      >
  ...
  monthRange = () => {
    ...
    for (let i = startYear; i <= endYear; i++) {
      const endMonth = i != endYear ? 11 : maxDate.getMonth();
      const startMon = i === startYear ? minDate.getMonth() : 0;
      let monthsList = [];
  ...
  renderMonths = () => {
    ...
    for (var i = 0; i < this.props.monthsShown; ++i) {
      ...
      monthList.push(
        ...
        >
          {this.renderHeader(months[i].year)}
          <Month
            ...
            monthsList={months[i].monthsList}
            year={months[i].year}
          />
        </div>
      );
  ...
  render() {
    ...
    return (
      <div ref={this.containerRef}>
        ...
        >
          {this.props.showPreviousButton && this.renderPreviousButton()}
